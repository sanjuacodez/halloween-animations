...
(function($) {
    ...
    class HalloweenSoundManager {
        constructor() {
            ...
            this.settings = (typeof wpHalloweenAjax !== 'undefined' && wpHalloweenAjax.soundSettings) ? wpHalloweenAjax.soundSettings : {};
            this.pluginUrl = (typeof wpHalloweenAjax !== 'undefined') ? wpHalloweenAjax.pluginUrl : '';
    ...
    $(document).ready(function() {
        ...
        if (typeof wpHalloweenAjax !== 'undefined' && 
            wpHalloweenAjax.soundSettings && 
            wpHalloweenAjax.soundSettings.enabled &&
            wpHalloweenAjax.pluginUrl) {

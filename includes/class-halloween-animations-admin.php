...
class Halloween_Animations_Admin {
    ...
    public function sound_field_callback() {
        ...
        // Add JavaScript for sound settings
        echo '<script>';
        echo 'jQuery(document).ready(function($) {';
        echo '    $("input[name=\"halloween_animations_settings[sound_enabled]\"]").change(function() {';
        echo '        $(".halloween-sub-settings").toggle(this.checked);';
        echo '    });';
        echo '    $("input[name=\"halloween_animations_settings[sound_volume]\"]").on("input", function() {';
        echo '        $("#volume-display").text(this.value + "%");';
        echo '    });';
        echo '});';
        echo '</script>';
    }
    ...
    public function enqueue_admin_scripts($hook) {
        ...
        wp_localize_script('halloween-animations-enhanced-sounds', 'wpHalloweenAjax', array(
